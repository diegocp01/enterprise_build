...
4. Report status, current and completed stages or rounds, agent-call count, gate and repair outcomes, frozen-vector digest, failure reason, and whether preview, video, and bundle evidence exist.
